...
if len(sys.argv) > 1:
    params = Parameters()
    config_file = "/home/jorge/work_dir/federado/Federado/flower_version/configs/x_ray/resnet_uganda.yaml" #sys.argv[1]
...
params.load_checkpoint = sys.argv[2]
#"/home/jorge/work_dir/federado/Federado/flower_version/models/model_españa.ckpt"
